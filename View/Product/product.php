        ...
        <div id="product-price">
            <div id="card-price" class="card p-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <button class="btn bg-red btn-lg col-11 m-auto" onclick="addCart(<?php echo $pro['pro_id']; ?>)" data-bs-toggle="modal" data-bs-target="#exampleModal">Añadir Al Carrito</button>
                    </div>
