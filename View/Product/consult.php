                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody id="tbody">
                        ...
                        foreach ($product as $pro) {
                            ...
                            echo "<td><button type='button' onclick='fModal(`Product`,`Delete`,`Estas seguro de Eliminar el proeedor <br>" . $pro['pro_name'] . "`," . $pro['pro_id'] . ")' class='btn btn-danger' data-bs-toggle='modal' data-bs-target='#staticBackdrop'>Eliminar</button></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
